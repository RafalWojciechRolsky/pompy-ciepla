...
const KlimatyzatoryPage = async () => {
  ...
  return (
    <>
      <Hero title={hero[4].title} points={hero[4].points} imageUrl={hero[4].imageUrl} />
      <Logos />
      <section className="airConditioners">
        <div className="airConditioners__container">
          <h2>Czym są i jak działają klimatyzatory</h2>
          <p>
            Klimatyzacja stała się nieodłącznym elementem naszego życia, zapewniając komfort
            termiczny w gorące dni i nie tylko. Ale czy kiedykolwiek zastanawiałeś się, jak
            dokładnie działają te urządzenia i jakie są różnice między klimatyzatorami a pompami
            ciepła? W tym wpisie przybliżymy budowę, działanie oraz rodzaje klimatyzatorów, a także
            wyjaśnimy, w jaki sposób nowoczesne technologie, takie jak klimatyzatory inwerterowe,
            łączą w sobie funkcje chłodzenia i ogrzewania. Jeśli chcesz dowiedzieć się więcej o
          ...
          <p>
            W parowniku następuje odparowanie czynnika chłodniczego, który pochłania ciepło z
            pomieszczenia. Następnie czynnik ten jest sprężany w sprężarce, co powoduje wzrost jego
            temperatury. Sprężony czynnik jest przetłaczany do skraplacza, który znajduje się na
            zewnątrz budynku. W skraplaczu ciepło z czynnika jest oddawane do powietrza
            zewnętrznego, a czynnik skrapla się i staje cieczą. Ciecz dostaje się do elementu
            rozprężnego, gdzie jest dławiona, co powoduje zmniejszenie jej ciśnienia i temperatury.
          ...
          <p>
            ...
            Najpopularniejsze są klimatyzatory typu split, które składają się z dwóch jednostek –
          ...
          <p>
            ...
            klimatyzatory typu split, ale do jednej jednostki zewnętrznej podłącza się wiele
            jednostek wewnętrznych. Pozwala to na schładzanie powietrza w kilku pomieszczeniach
            jednocześnie z pomocą jednej instalacji.
          </p>
          <h4>Klimatyzatory przenośne</h4>
          <p>
            Klimatyzatory przenośne to urządzenia, które mają wszystkie podzespoły (parownik,
            skraplacz, sprężarka, zawór rozprężny i wentylator) w jednej obudowie. Są one łatwe do
          ...
          <p>
            ...
            cech i mogą pełnić podobne funkcje. Obie te technologie wykorzystują procesy
            termodynamiczne do przenoszenia ciepła, ale różnią się w sposobie, w jaki to robią i w
            zakresie ich zastosowań.
          </p>
          <h4>Różnice między klimatyzatorami a pompami ciepła</h4>
          <p>
            Klimatyzator to urządzenie, które służy głównie do chłodzenia pomieszczeń poprzez
            usuwanie ciepła z powietrza wewnętrznego i odprowadzanie go na zewnątrz. Klimatyzatory
            mogą również poprawiać jakość powietrza poprzez filtrację oraz usuwanie bakterii i
            grzybów. Klimatyzatory rozprowadzają chłód po pomieszczeniu bezpośrednio nadmuchowo.
          </p>
          <p>
            Z drugiej strony, pompa ciepła to urządzenie, które może służyć do chłodzenia i
            ogrzewania pomieszczeń poprzez wykorzystanie ciepła z zewnętrznych źródeł, takich jak
            powietrze, woda czy gleba. Pompy ciepła są bardziej wszechstronne niż klimatyzatory,
            ponieważ mogą być wykorzystywane nie tylko do chłodzenia, ale także do ogrzewania
          ...
          <p>
            ...
            Wybór między nimi zależy od indywidualnych potrzeb i preferencji, a także od specyfiki
            budynku, w którym mają być zainstalowane.
          </p>
        </div>
      </section>
    </>
