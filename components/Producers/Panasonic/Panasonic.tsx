...
const Panasonic: FC<IPropsTypes> = (props) => {
  return (
    <section className="panasonic">
      <h2>Panasonic</h2>
      <p>
        Firma Panasonic, która ma swoją ponad 100 letnią historię. Została założona w 1918 r. przez
        jej założyciela, Konosuke Matsushitę, i poprzez swoją działalność biznesową angażuje się w
        postęp i rozwój społeczeństwa oraz dobrobyt ludzi, podnosząc tym samym jakość życia na całym
        świecie. Nie da się w kilka krótkich słowach opisać zakres działania firmy Panasonic. Jest
        to korporacja o światowym zasięgu i działająca w na wielu polach.
      </p>
      <p>
      ...
      <p>
        Podstawowy cel został sformułowany w 1929 roku przez założyciela firmy, Konosuke Matsushita
        i brzmi nastepująco - "Uznając nasze obowiązki jako przemysłowców, poświęcimy się postępowi
        i rozwojowi społeczeństwa oraz dobrobytowi ludzi poprzez naszą działalność biznesową,
        podnosząc tym samym jakość życia na całym świecie."
      </p>
      ...
      <div className="panasonic__sub-section">
        <div className="text">
          <ul>
            ...
            <li>1985 Wprowadzenie pierwszego klimatyzatora VRF typu GHP (gazowa pompa ciepła).</li>
            <li>
            ...
            <li>
              2010 Nowy Aquarea. Panasonic wprowadza na rynek europejski Aquarea, nowy, innowacyjny
              system o niskim zużyciu energii.
            </li>
            <li>
      ...
      <ul>
        ...
        <li>
          <a href="https://www.youtube.com/@PanasonicAirCon">Link do kanału Panasonic na youtube</a>
        </li>
      </ul>
    </section>
  );
