  ...
  return (
    <section className="gree">
      <div className="gree__container">
        ...
        <p>
          Założona w 1991 roku, Gree Electric Appliances, Inc. of Zhuhai została notowana na
          giełdzie w Shenzhen w listopadzie 1996 roku. Na początku swojego powstania firma polegała
          głównie na montażu i produkcji klimatyzatorów domowych. GREE była małą manufakturą z
          liniami produkcyjnymi klimatyzatorów okiennych. Dzięki serii produktów rynkowych, GREE
          zdobyło możliwości rynkowe i zaczęło budować wizerunek marki, co stworzyło dobre podstawy
          do przyszłego rozwoju.
        </p>
        <p>
          Posiada 30 "wiodących na arenie międzynarodowej" technologii, 2 państwowe nagrody za
          postęp naukowo-techniczny, 2 państwowe nagrody za wynalazki technologiczne i 4 nagrody za
          chińskie patenty.
        </p>
