...
const ProducenciPage = async () => {
  ...
  return (
    <>
      <Hero
        title={hero[3].title}
        points={hero[3].points}
        imageUrl={hero[3].imageUrl}
      />
      <Logos />
    </>
  );
...
const title = "Nasze realizacje | Pompy Ciepła 4 You | Ciepło z natury";
const description =
  "Odkryj nasze realizacje pomp ciepła, które zapewniają efektywność energetyczną i komfort cieplny, dbając o środowisko naturalne.";
