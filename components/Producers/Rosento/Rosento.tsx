    ...
    <section className="rosento">
      <div className="rosento__container">
        ...
        <p>
          ...
          przyjaznych środowisku systemów klimatyzacyjnych. Misją firmy jest dostarczanie
          najnowszych rozwiązań w branży klimatyzacji, wentylacji i ogrzewania, opartych na
          wysokowydajnej, energooszczędnej technologii inwerterowej.
        </p>
        <p>
        ...
        <p>
          W fabrykach Rotenso zlokalizowanych w sercu Azji powstają unikalne i innowacyjne
          rozwiązania technologiczne. W nich pomysły przekształcają się w rozwiązania - kompletne
