    ...
    <section className="haier">
      <div className="haier__container">
        ...
        <p>
          ...
          wiedzę na opracowanie najlepszych urządzeń, aby zadowolić najbardziej wymagających
          klientów.
        </p>
        <p>
        ...
        <p>
          Od tego czasu firma ewoluowała wraz ze zmieniającymi się wymaganiami współczesnego świata
          i dzisiejszego konsumenta, wykorzystując swoje podstawowe wartości, jakimi są jakość i
